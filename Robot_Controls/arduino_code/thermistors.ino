...
void loop() {
  ...
  // ================================
  VRT1 = (5.00 / 1023.00) * analogRead(A0);  // Voltage across thermistor 1 D26
  ...
  // ================================
  VRT2 = (5.00 / 1023.00) * analogRead(A1);  // Voltage across thermistor 2 D14
  ...
  // ================================
  VRT3 = (5.00 / 1023.00) * analogRead(A2);  // Voltage across thermistor 3 D27
